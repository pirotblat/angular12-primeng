...
export class ProductService {
    ...
    getProductOrderFromSql() {
      return this.http.get<any>('http://localhost:3000/products/getProductOrder');
      // return this.http.get<any>('http://localhost:3000/products/getProductOneOrder/1000');
    }
